...
<?php
    ...
    $ml = $_GET["ml"];
    $sps = $db->executeReader('SELECT * FROM `sanpham` WHERE MaLoai = ?', array($ml));
?>
       ...
       <!-- <div class="container-fluid"> -->
        ...
        <div class="row">
            ...
            <div class="col col-md-8"  style="background-color:lavender;">
                ...
                <div style="text-transform: uppercase; font-size: 20px;">sản phẩm theo loại</div>
                <div class="row">
                    ...
                    if(count($sps) > 0) {
                        ...
                        <div class="col-3" style="margin-top: 40px;">
                            <img style="width: 60%; max-height: 150px;" src="./Images_KTL2/<?php echo $sp->Anh ?>" />
                            <div>
                                Tên SP: <?php echo $sp->TenSP ?>
                            </div>
                            <a href="ShowDetail.php?masp=<?php echo $sp->MaSP ?>">Xem chi tiết</a>
                        </div>
                            <?php
                        }
                    }
                        ...
                        ?>
                    <div class="col-12" style="margin-top: 30px; text-align: center;">Không có sản phẩm nào thuộc loại này</div>
                        <?php
                    }
                    ?>
