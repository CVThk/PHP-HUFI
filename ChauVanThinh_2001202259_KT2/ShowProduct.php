...
<?php
    ...
    $count = ($db->executeReader("SELECT COUNT(*) AS 'count' FROM `sanpham`")[0])->count;
    $pager = new Pager();
    $lim = 12;
    ...
    $sps = $db->executeReader("SELECT * FROM `sanpham` limit $posStart, $lim");
?>
       ...
       <!-- <div class="container-fluid"> -->
        ...
        <div class="row">
            ...
            <div class="col col-md-8"  style="background-color:lavender;">
                ...
                <div style="text-transform: uppercase; font-size: 20px;">Danh sách tất cả sản phẩm</div>
                <div class="row">
                    <?php
                    foreach($sps as $sp) {
                        ?>
