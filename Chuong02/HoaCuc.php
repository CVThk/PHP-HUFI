...
<body>
    ...
    ?>
    <h2 style="text-transform: uppercase; color:blue; text-align: center; margin-top:20px;">hoa cúc</h2>
            ...
            foreach($hoas as $hoa) {
                ...
                <div class="col-md-3" style="border-radius: 4px; border:1px solid red;display:flex; align-items: center; margin:10px; padding:10px;">
                    ...
                    <div>
                        ...
                        <p style="color:red;"><span style="font-weight: bold; color:black;">Đơn giá: </span><?php echo number_format($hoa->gia, 0, ",", ".")." VNĐ"; ?></p>
                    </div>
                </div>
                <?php
            }
